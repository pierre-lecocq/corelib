# File: model_spec.rb
# Time-stamp: <2018-02-13 21:21:10>
...
describe Corelib::Model do
  before :all do
    Corelib::Database.exec_params 'CREATE TABLE IF NOT EXISTS test_tmp' \
  ...
  after :all do
    Corelib::Database.exec_params 'DROP TABLE IF EXISTS test_tmp'
  end
